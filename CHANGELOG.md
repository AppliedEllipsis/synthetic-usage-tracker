...
- Changed license from MIT to GPL-3.0 in package.json
- Changed license reference from "MIT License" to "GPL-3.0 License" in README.md
- Had the wrong license name documented but linked to GPL.
